...
const Login = () => {
  ...
  return (
    <div>
      <Header title="DAYORI" close={true} maximize={true} />
      <div className={styles.login_logo}>
        <img src={Logo} alt="Dayori Logo" />
      </div>
      <div className={styles.login_input}>
        <Input title="Email" value={email} placeHolder="Email을 입력하세요." buttonFlag={false} func={emailHandler} />
        <Input
          title="Password"
          value={password}
        ...
        <div className={styles.login_button}>
          <SubmitButton labelprops="로그인" onClick={login} />
        </div>
